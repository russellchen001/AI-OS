    ...
    -> Result<(), String>
{
    ...
    Err(
        "Docker Desktop did not become ready within 45 seconds."
            .to_string(),
    )
}

fn find_open_webui_container()
...
fn start_open_webui_container()
    -> Result<String, String>
{
    ensure_docker_ready()?;

    let container_name =
        find_open_webui_container()?
            .ok_or_else(|| {
    ...
    -> Result<String, String>
{
    ...
    let container_name =
        find_open_webui_container()?
            .ok_or_else(|| {
                "Open WebUI container was not found."
                    .to_string()
            })?;
...
"#,
    ...
    "🚀 Start All command sent. Docker and Open WebUI may need up to 45 seconds."
        .to_string()
}
...
"#,
        ...
        "Docker" => {
            ...
            Ok(
                "🚀 Docker Desktop is starting. Please allow up to 45 seconds."
                    .to_string(),
            )
        }
        ...
        "Cherry Studio" => {
            ...
            Ok(
                "🚀 Cherry Studio start command sent."
                    .to_string(),
            )
        }
...
"#,
        ...
        "Docker" => {
            if !docker_is_ready() {
                return Ok(
                    "✅ Docker Desktop is already stopped."
                        .to_string(),
                );
            }
...
"#,
            ...
            Ok(
                "🛑 Cherry Studio stop command sent."
                    .to_string(),
            )
        }
