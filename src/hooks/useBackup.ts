...
function useBackup({
  ...
  const runBackup =
    useCallback(async () => {
      ...
      if (!destination) {
        const message =
          "Please enter a backup directory first.";
        ...
        try {
          ...
          if (
            ...
            try {
              ...
              console.error(
                "Unable to parse restored settings:",
                parseError,
              );
            }
          }
    ...
    useCallback(
      async (
        ...
        try {
          ...
          onMessage(
            `Unable to reveal backup: ${String(
              nextError,
            )}`,
          );
        }
    ...
    useCallback(
      async (
        ...
        try {
          ...
          onMessage(
            `Unable to delete backup: ${String(
              nextError,
            )}`,
          );
        } finally {
