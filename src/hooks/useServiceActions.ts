...
export function useServiceActions({
    ...
    try {
      ...
      window.setTimeout(async () => {
        ...
        try {
          ...
          addLog(
            "success",
            "Open WebUI opened automatically",
          );
        } catch (error) {
          const errorMessage =
            `Failed to automatically open Open WebUI: ${String(
              error,
            )}`;
  ...
  async function stopService(
    ...
    try {
      ...
      const result =
        await stopSingleService(service);
