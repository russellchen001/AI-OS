...
required_tests=(
  ...
  "ebay_origins_are_exact_and_malicious_lookalikes_are_rejected"
...
echo "✓ eBay provider origins are exact and malicious lookalikes are rejected"
echo "✓ provider/origin validation is fail-closed"
echo "PASS $name"
echo "WAITING_FOR_USER browser providers: real account E2E required"
