...
run_check "bounded Word unit contract" cargo test --manifest-path "$MANIFEST" document::word::tests:: -- --skip word_readback_real_e2e --skip word_pdf_export_real_e2e --skip word_realistic_workflow_real_e2e --skip word_writes_the_format_the_extension_promises_real_e2e
...
run_check "Word writes the format the extension promises" cargo test --manifest-path "$MANIFEST" document::word::tests::word_writes_the_format_the_extension_promises_real_e2e -- --ignored --exact
